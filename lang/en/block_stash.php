...
$string['collected'] = '{$a->name}: {$a->collected} of {$a->total}'; // e.g. "Treasure items: 3 of 5"
$string['collectionitems'] = 'Items in the collection';
$string['collectionname'] = 'Collection name';
$string['collections'] = 'Collections';
$string['collectionslist'] = 'List of collections';
...
$string['prizeitems'] = 'Prizes on completion';
...
$string['removeoncompletion'] = 'Remove collection items when complete (and prize given)';
...
$string['showtostudent'] = 'Show collection to students';
