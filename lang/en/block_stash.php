...
$string['addrandomdrop'] = 'Add random drop';
$string['addrandomdroppoolitem'] = 'Add item to this random drop';
...
$string['pickuptoastfound'] = 'You found {$a}';
$string['pickuptoastreceived'] = 'You received {$a}';
...
$string['randomdroppoolweighthigh'] = 'High';
...
$string['tradetoastreceivedmultiple'] = 'Trade complete! You received {$a}.';
$string['tradetoastreceivedsingle'] = 'Trade complete! You received {$a}.';
